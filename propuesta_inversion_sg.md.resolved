...
```mermaid
graph LR
    A["📝 Simulacro ICFES\n196 preguntas\n5 materias"] --> B["📲 Estudiantes suben\nrespuestas a nuestros\nformularios digitales"]
    B --> C["⚙️ Motor de\nProcesamiento\nCalibrado"]
    C --> D["🎓 Portal\nEstudiante"]
    C --> E["🏫 Panel\nInstitucional"]
    C --> F["👨‍🏫 Tutorías\nPersonalizadas"]
...
graph TD
    subgraph "💰 INVERSIÓN"
        A["🎓 SERVICIOS PARA EL ESTUDIANTE\nEl estudiante elige lo que desea\nCada servicio es opcional e individual"]
        B["🏫 HERRAMIENTAS PARA LA INSTITUCIÓN\nPago único por simulacro\nAcceso a todo el ecosistema analítico"]
    end
    A --> A1["Simulacro\n$10.000/est."]
    A --> A2["Portal Web\n$5.000/est."]
    A --> A3["20h Tutores\n$15.000/est."]
    B --> B1["Paquete Base\n$50.000/simulacro"]
    B --> B2["Paquete Completo\n$150.000/simulacro"]
```
...
```mermaid
graph TD
    A["Todos los estudiantes\nevaluados"] --> B{"Análisis\nAutomático"}
    B --> C["🔴 CRÍTICO\nPuntaje global muy bajo\n→ Orientador + plan urgente"]
    B --> D["🟠 ALTO\nBrecha grande entre materias\n→ Tutoría focalizada"]
...
```mermaid
graph TD
    subgraph "🎓 ESTUDIANTE — elige lo que desea"
        S1["A · Simulacro\n$10.000 ✅ obligatorio"]
        S2["B · Portal Web\n$5.000 ❌ opcional"]
        S3["B+ · 20h Tutores\n$15.000 ❌ opcional"]
    end
    subgraph "🏫 INSTITUCIÓN — pago único"
        I1["Base\n$50.000/simulacro"]
        I2["Completo\n$150.000/simulacro"]
    end
```
